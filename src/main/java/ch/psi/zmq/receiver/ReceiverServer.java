...
public class ReceiverServer {
	...
	private static final Logger logger = Logger.getLogger(ReceiverServer.class.getName());
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		ReceiverServerConfiguration configuration = new ReceiverServerConfiguration();
		...
		resourceConfig.register(ReceiverService.class);
		resourceConfig.register(new ReceiverServerResourceBinder(configuration));
		HttpServer server = GrizzlyHttpServerFactory.createHttpServer(baseUri, resourceConfig);

		// Static content
		String home = System.getenv("RECEIVER_BASE");
		if (home == null) {
